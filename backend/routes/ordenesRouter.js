...
import {
    ...
    actualizarOrden,
    desactivarOrden, obtenerOrdenesCliente, cancelarOrden, actualizarDetalles
...
router.put('/detalles/:id',autenticacionToken, verificarRol(roles.OPERADOR), actualizarDetalles);
